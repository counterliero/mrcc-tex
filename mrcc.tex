...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Author stuff starts here!                                                                               %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\author{Max Mustermann}
\title{Titel der Arbeit}
\bibfiles{literature}
\supervisor{Matthias Splieth, M. Sc.}
...
\placeofbirth{Lummerland} % only for diss
...
\begin{document}
	...
	\renewcommand{\chaptermark}[1]{\markboth{\textsc{\thechapter.\ #1}}{}} % fix for header
	\begin{appendix}
		\chapter{Ein Anhang}
		\dots{}
	\end{appendix}
